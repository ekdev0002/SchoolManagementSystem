...
public class UIGestionBulletin extends AbstractUIOperation implements IUGestionBulletin{
	
	private static final URL DEFAULT_URL_PICTURE = UIGestionBulletin.class.getResource("/images/inconnu.png");
	...
	public UIGestionBulletin() {

		setMinimumSize(new Dimension(834, 573));
		setSize(new Dimension(834, 582));
		setPreferredSize(new Dimension(834, 573));
		operationIcon.setIcon(new ImageIcon(UIGestionBulletin.class.getResource("/images/imageBulletin.png")));
		...
		genererButton = new JButton("Genener les Bulletins");
		genererButton.setHorizontalAlignment(SwingConstants.RIGHT);
		rechercherPanel.add(genererButton);
