...
public class UIConsulterEleve extends AbstractUIOperation implements IUConsulterEleve {
	...
	private JComboBox<String> typeRecherche;
	...
	public UIConsulterEleve() {
		...
		FlowLayout flowLayout = (FlowLayout) rechercherPanel.getLayout();
		flowLayout.setVgap(2);
		centerPanel.add(rechercherPanel, BorderLayout.NORTH);
		
		JLabel rechercherLabel = new JLabel("Critère de recherche (Field : Libellé)");
		rechercherPanel.add(rechercherLabel);
		
		typeRecherche = new JComboBox<>();
		typeRecherche.setModel(new DefaultComboBoxModel<String>(new String[] {Criteria.Contains.name(), Criteria.Like.name(), Criteria.Equal.name()}));
		rechercherPanel.add(typeRecherche);
		
		critere = new JTextField();
		rechercherPanel.add(critere);
		critere.setColumns(20);
		
		goButton = new JButton("Go");
		goButton.setPreferredSize(new Dimension(47, 20));
		goButton.setMinimumSize(new Dimension(47, 20));
		goButton.setMaximumSize(new Dimension(47, 20));
		rechercherPanel.add(goButton);
		...
		clearButton.setBounds(117, 16, 80, 20);
		...
		annulerButton.setBounds(207, 16, 80, 20);
