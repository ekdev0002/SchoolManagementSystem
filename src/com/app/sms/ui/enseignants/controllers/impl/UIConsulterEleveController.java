...
import com.app.sms.ui.enseignants.controllers.IUIConsulterEleveController;
...
public class UIConsulterEleveController implements IUIConsulterEleveController {
	...
	public UIConsulterEleveController(UIConsulterEleve uIConsulterEleve, Eleve eleve) {
		...
		try {
			List<Eleve> eleves = Eleve.list(MainUIApplication.getCurrentUser().getId());
		...
		uIConsulterEleve.addUpdateListener( new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					eleve.update();
					uIConsulterEleve.loadData(Eleve.list(MainUIApplication.getCurrentUser().getId()));
